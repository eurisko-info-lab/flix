...
object PrimitiveEffects {
  ...
  /**
    ...
    */
  private val packageEffs: Map[Package, Set[ast.Symbol.EffectSym]] = loadPackageEffs()
  ...
  /**
    ...
    */
  private val classEffs: Map[Class[?], Set[ast.Symbol.EffectSym]] = loadClassEffs()

  /**
    * A pre-computed map from constructors to effects.
    */
  private val constructorEffs: Map[Constructor[?], Set[ast.Symbol.EffectSym]] = loadConstructorEffs()

  /**
    * A pre-computed map from methods to effects.
    */
  private val methodEffs: Map[Method, Set[ast.Symbol.EffectSym]] = loadMethodEffs()
  ...
  /**
    ...
    */
  private def toEffSet(effs: Set[ast.Symbol.EffectSym], loc: SourceLocation): Type = {
  ...
  /**
    ...
    * }}}
    */
  private def loadPackageEffs(): Map[Package, Set[ast.Symbol.EffectSym]] = {
  ...
  /**
    ...
    * }}}
    */
  private def loadClassEffs(): Map[Class[?], Set[ast.Symbol.EffectSym]] = {
  ...
  /**
    ...
    */
  private def loadConstructorEffs(): Map[Constructor[?], Set[ast.Symbol.EffectSym]] = {
  ...
  /**
    ...
    * Note: The effect set applies to *ALL* constructors of the class.
    */
  private def loadMethodEffs(): Map[Method, Set[ast.Symbol.EffectSym]] = {
  ...
  /**
   * Returns the given comma-separated string of effect symbols as a set of [[ast.Symbol.EffectSym]].
   *
   * Returns the empty set if the string is empty.
   */
  private def parseEffSet(s: String): Set[ast.Symbol.EffectSym] = {
    if (s.trim.isEmpty)
      Set.empty
    else

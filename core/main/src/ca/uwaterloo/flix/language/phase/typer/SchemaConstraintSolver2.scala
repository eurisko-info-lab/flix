...
//
// This is a copy of the RecordConstraintSolver2. Because the shapes are slightly different, we cannot reuse the same solver.
//
object SchemaConstraintSolver2 {
  ...
  /**
    ...
    */
  private def pivot(row: Type, hdLabel: Name.Pred, hdTpe: Type, tvars: Set[Symbol.KindedTypeVarSym])(implicit scope: Scope, renv: RigidityEnv, flix: Flix): Option[(Type, Substitution)] = {

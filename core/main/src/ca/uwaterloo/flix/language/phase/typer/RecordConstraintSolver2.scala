...
object RecordConstraintSolver2 {
  ...
  /**
    ...
    */
  private def pivot(row: Type, hdLabel: Name.Label, hdTpe: Type, tvars: Set[Symbol.KindedTypeVarSym])(implicit scope: Scope, renv: RigidityEnv, flix: Flix): Option[(Type, Substitution)] = {

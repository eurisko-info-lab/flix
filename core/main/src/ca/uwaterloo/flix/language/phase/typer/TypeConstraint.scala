...
object TypeConstraint {
  ...
  /**
    ...
    * }}}
    */
  case class Trait(sym: ast.Symbol.TraitSym, tpe: Type, loc: SourceLocation) extends TypeConstraint
  ...
  object Provenance {
    ...
    /**
      ...
      */
    case class ExpectArgument(expected: Type, actual: Type, sym: ast.Symbol, num: Int, loc: SourceLocation) extends Provenance

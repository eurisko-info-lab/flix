...
object DerivationError {
  ...
  /**
    ...
    */
  case class IllegalDerivation(sym: ast.Symbol.TraitSym, legalSyms: List[ast.Symbol.TraitSym], loc: SourceLocation) extends DerivationError {
  ...
  /**
    ...
    */
  case class IllegalDerivationForEmptyEnum(sym: ast.Symbol.EnumSym, classSym: ast.Symbol.TraitSym, loc: SourceLocation) extends DerivationError {

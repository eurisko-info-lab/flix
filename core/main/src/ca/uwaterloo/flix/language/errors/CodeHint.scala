...
object CodeHint {
  ...
  /**
    ...
    */
  case class LazyEvaluation(sym: ast.Symbol.DefnSym, loc: SourceLocation) extends CodeHint {
  ...
  /**
    ...
    * @param loc the location associated with the code hint.
    */
  case class ParallelEvaluation(sym: ast.Symbol.DefnSym, loc: SourceLocation) extends CodeHint {
  ...
  /**
    ...
    * @param loc the location associated with the code hint.
    */
  case class SuggestPurityForLazyEvaluation(sym: ast.Symbol.DefnSym, loc: SourceLocation) extends CodeHint {
